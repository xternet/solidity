...
{
	Scope scope;
	Interpreter{_state, _dialect, scope, _enableExternalCalls, _disableMemoryTrace}(_ast);
}
...
{
	ExpressionEvaluator ev(m_state, m_dialect, *m_scope, m_variables, m_enableExternalCalls, m_disableMemoryTrace);
