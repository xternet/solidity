...
{
	Scope scope;
	InspectedInterpreter{_inspector, _state, _dialect, scope, _enableExternalCalls, _disableMemoryTrace}(_ast);
}
...
{
	InspectedExpressionEvaluator ev(m_inspector, m_state, m_dialect, *m_scope, m_variables, m_enableExternalCalls, m_disableMemoryTrace);
