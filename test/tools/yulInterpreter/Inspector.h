...
public:
	...
	InspectedInterpreter(
		...
		Interpreter(_state, _dialect, _scope, _enableExternalCalls, _disableMemoryTracing, _variables),
...
public:
	InspectedExpressionEvaluator(
		...
		ExpressionEvaluator(_state, _dialect, _scope, _variables, _enableExternalCalls, _disableMemoryTrace),
		m_inspector(_inspector)
	{}
